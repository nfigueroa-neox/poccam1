...
| **📸 Comparación del último cambio** | El par **ANTES / DESPUÉS**: las dos imágenes que el detector realmente comparó, cada una con su fecha (incluye milisegundos). Antes se mostraban "las 2 últimas capturas", que eran dos eventos distintos sin relación entre sí y no explicaban nada. Si aún no hubo eventos, lo indica |
